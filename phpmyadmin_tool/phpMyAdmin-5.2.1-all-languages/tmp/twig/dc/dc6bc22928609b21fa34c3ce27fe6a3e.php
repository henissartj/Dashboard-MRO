...
";
    ...
    {
        return new Source("", "config/form_display/display.twig", "/opt/mro_dash/phpmyadmin_tool/phpMyAdmin-5.2.1-all-languages/templates/config/form_display/display.twig");
    }
}
