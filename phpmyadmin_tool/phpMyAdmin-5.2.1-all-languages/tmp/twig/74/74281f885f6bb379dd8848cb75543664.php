...
($context["position"] ?? null) == "right")) {
  ...
  ";
    ...
    {
        return new Source("", "display/results/checkbox_and_links.twig", "/opt/mro_dash/phpmyadmin_tool/phpMyAdmin-5.2.1-all-languages/templates/display/results/checkbox_and_links.twig");
    }
}
