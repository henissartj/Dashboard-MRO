...
";
    ...
    {
        return new Source("", "database/structure/favorite_anchor.twig", "/opt/mro_dash/phpmyadmin_tool/phpMyAdmin-5.2.1-all-languages/templates/database/structure/favorite_anchor.twig");
    }
}
