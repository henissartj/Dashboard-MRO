...
";
    ...
    {
        return new Source("", "recent_favorite_table_no_tables.twig", "/opt/mro_dash/phpmyadmin_tool/phpMyAdmin-5.2.1-all-languages/templates/recent_favorite_table_no_tables.twig");
    }
}
