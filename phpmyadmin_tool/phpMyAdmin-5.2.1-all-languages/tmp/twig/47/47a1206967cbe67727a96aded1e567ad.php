...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/opt/mro_dash/phpmyadmin_tool/phpMyAdmin-5.2.1-all-languages/templates/database/structure/bulk_action_modal.twig");
    }
}
