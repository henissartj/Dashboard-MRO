...
app.layout = html.Div(
    ...
    children=[
        ...
        dcc.Store(id="dynamic-meta-store"),
    ],
)
...
app.clientside_callback(
    ...
    """,
    Output("dynamic-meta-store", "data"),
    Input("lang-store", "data"),
)
...
def inject_structured_data(pathname, lang_data):
    ...
    metas = [
        ...
        html.Meta(name="og:image", content=base + "/assets/screenshot_home.png"),
        # Twitter utilise déjà name=*
        html.Meta(name="twitter:card", content="summary_large_image"),
        html.Meta(name="twitter:title", content=title),
        html.Meta(name="twitter:description", content=desc),
        html.Meta(name="twitter:image", content=base + "/assets/screenshot_home.png"),
    ]
